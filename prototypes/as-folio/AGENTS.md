# Selected as-folio implementation notes

- This directory is a cloud-synced source deliverable, never a build workspace.
- Keep dependencies, caches, `.astro`, `dist`, and browser profiles in the approved local
  scratch workspace documented in `README.md`.
