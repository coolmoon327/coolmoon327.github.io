  ...
  playground: {
    games: [
      ...
      },
      {
        ...
        category: 'learning',
        height: 500,
        title: { en: 'Q-Path Lab', zh: 'Q 学习寻路' },
        meta: { en: 'Q-learning · 200 episodes', zh: 'Q 学习 · 200 回合' },
        description: {
          en: 'Choose a goal, train a compact Q-table, then watch the learned greedy policy cross a five-by-five grid.',
          zh: '选定目标后，让智能体学习一个小型 Q 表，再观察它如何按照学到的贪心策略穿过 5×5 网格。',
        },
        tags: {
          en: ['Real Q-learning', 'Policy arrows', 'Success rate'],
          zh: ['Q 学习', '策略箭头', '成功率'],
        },
      },
      {
      ...
      },
      {
        ...
        category: 'wireless',
        height: 520,
        title: { en: 'Jammer Hop', zh: '频跳突围' },
        meta: { en: 'Anti-jamming · 30–60 sec', zh: '抗干扰 · 30–60 秒' },
        description: {
          en: 'Hop among three channels, deliver packets through a moving spectrum, and stay one step ahead of sweep and reactive jammers.',
          zh: '在三个信道之间切换，避开扫频干扰与反应式干扰，把尽可能多的数据包送到接收端。',
        },
        tags: {
          en: ['Channel hopping', 'Live throughput', 'Adaptive jammer'],
          zh: ['跳频通信', '实时吞吐率', '反应式干扰机'],
        },
      },
      {
        id: 'orbit',
        category: 'micro',
        height: 360,
        title: { en: 'Orbit Alignment', zh: '月轨对准' },
        meta: { en: 'Timing · 10–20 sec', zh: '时机判断 · 10–20 秒' },
        description: {
          en: 'Start the orbit, then stop the moon inside the bright window. Two clicks are enough for a complete attempt.',
          zh: '点一下启动月球，再点一下将它停在发光窗口内；每局只需两次操作。',
        },
        tags: { en: ['Two clicks', 'Timing', 'Assist mode'], zh: ['两次点击', '时机', '辅助提示'] },
      },
      {
        id: 'signature',
        category: 'micro',
        height: 260,
        title: { en: 'Stardust Signature', zh: '星图签名' },
        meta: { en: 'Ambient · 5–30 sec', zh: '轻互动 · 5–30 秒' },
        description: {
          en: 'Leave seven points in the sky and turn a brief pause into a small constellation.',
          zh: '在夜空中点下七颗星，把片刻停留连成一幅自己的小星图。',
        },
        tags: {
          en: ['Click / Enter', 'No score', 'Ambient'],
          zh: ['点击 / 回车', '没有输赢', '轻量互动'],
        },
      },
      {
        ...
        category: 'casual',
        height: 430,
        title: { en: 'Memory Echo', zh: '记忆回响' },
        meta: { en: 'Memory · 30 sec–3 min', zh: '记忆挑战 · 30 秒–3 分钟' },
        description: {
          en: 'Watch four pads light up, then replay a sequence that grows one step at a time.',
          zh: '观察四个色块依次亮起，再按原顺序复现；序列每轮增加一步。',
        },
        tags: {
          en: ['Keys 1–4', 'Ten rounds', 'Assist mode'],
          zh: ['按键 1–4', '10 个回合', '辅助提示'],
        },
      },
      {
        id: 'match',
        category: 'casual',
        height: 590,
        title: { en: 'Memory Garden', zh: '花园配对' },
        meta: { en: 'Matching · 1–4 min', zh: '翻牌配对 · 1–4 分钟' },
        description: {
          en: 'Find eight pairs hidden under a compact four-by-four garden and improve your best move count.',
          zh: '翻开 4×4 花园中的卡片，找齐 8 对图案，并尝试用更少的步数完成。',
        },
        tags: {
      ...
      },
      {
        ...
        category: 'casual',
        height: 700,
        title: { en: 'Merge Garden', zh: '合成花园' },
        meta: { en: 'Merge · 3–10 min', zh: '合成游戏 · 3–10 分钟' },
        description: {
          en: 'Combine equal samples across a four-by-four board and grow one seed toward a finished paper.',
          zh: '在 4×4 棋盘上合并相同样本，从一颗种子逐步合成一篇完整的论文。',
        },
        tags: {
          en: ['Arrow keys', 'Local best', 'Longer session'],
          zh: ['方向键', '本机最佳记录', '适合多玩几局'],
        },
      },
      {
        id: 'resource',
        category: 'casual',
        height: 540,
        title: { en: 'Resource Net', zh: '资源连线' },
        meta: { en: 'Network puzzle · 1–5 min', zh: '网络拼图 · 1–5 分钟' },
        description: {
          en: 'Rotate a compact network until compute, storage, and image nodes all connect to the coordinator, then watch requests flow.',
          zh: '旋转网络节点，把计算、存储和镜像资源全部接入协调器；连通后，数据会沿着路径流动。',
        },
        tags: {
          en: ['Rotate tiles', 'Always solvable', 'OpenRaaS theme'],
          zh: ['旋转节点', '每局可解', 'OpenRaaS 主题'],
        },
      },
    ],
    locales: {
      en: {
        ...
        title: 'Playground',
        intro:
          'Fourteen small, dependency-free games live inside the site rather than taking it over. Four wireless experiments turn antennas, interference, and anti-jamming into direct interactions; four more make reward, learning, and policy concepts playable.',
      ...
      zh: {
        ...
        title: '小游戏实验室',
        intro:
          '这里有 14 款无需额外依赖的轻量小游戏，嵌在页面里随手就能玩，也不会喧宾夺主。其中 4 款围绕天线、干扰和物理层安全，另有 4 款把奖励、策略与强化学习变成直观操作。',
        ...
        sections: [
          {
            ...
            title: '把强化学习玩明白',
            intro:
              '先动手，再理解术语：从奖励、探索与利用，到 Q 学习和折扣回报，都能在几次操作中看到结果。',
          },
          {
            id: 'wireless',
            number: '02',
          ...
          },
          {
            ...
            number: '03',
            title: '藏在页面里的小互动',
            intro: '只需一两次点击，适合放在文章旁、项目说明里，或主页不经意的角落。',
          },
          {
            id: 'casual',
            number: '04',
            title: '想多玩一会儿',
            intro:
              '翻牌、合成和连线等耐玩的小谜题都收在卡片里，既能消磨几分钟，也不会占满整个页面。',
          },
        ],
      },
    },
