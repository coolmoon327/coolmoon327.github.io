    ...
    localized: {
      en: {
        news: {
          ...
          title: 'Research News',
          intro:
            'Curated, source-linked updates across secure wireless systems, advisor publications, and selected research interests.',
      ...
      zh: {
        news: {
          eyebrow: '科研动态',
          title: '研究资讯',
          intro: '持续整理安全无线系统、导师成果与关注方向的新进展，并附上可核查的来源。',
          filtersLabel: '筛选研究动态',
          moduleLabel: '模块',
          keywordLabel: '关键词',
          authorLabel: '作者',
