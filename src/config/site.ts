  ...
  research: {
    en: {
      ...
      inlineGame: {
        ...
        body: "Adjust Alice's antenna azimuth and compare Bob's and Eve's achievable rates on a full-room energy map. Opaque obstacles block line of sight; optional walls join the same lossy specular model for up to three reflections in total.",
        collectionLabel: 'Explore the full playground',
    ...
    zh: {
      ...
      inlineGame: {
        ...
        eyebrow: '交互模型 · 物理层安全',
        title: '亲手调整一束保密波束',
        body: '调整 Alice 的天线方位角，通过全空间能量图比较 Bob 与 Eve 的可达速率。障碍物会完全遮断视距传播；启用墙面反射后，墙与障碍物采用同一种有损镜面模型，合计最多发生三次反射。',
        collectionLabel: '前往小游戏实验室',
  ...
  playground: {
    games: [
      ...
      },
      {
        ...
        description: {
          en: "Steer Alice's beam across a full-room local-average-energy map. Opaque obstacles remove blocked line-of-sight components; optional walls use the same lossy specular law, with at most three reflections across walls and obstacles. Compare Bob's and Eve's achievable rates, then maximize instantaneous secrecy rate.",
          zh: '在全空间局部平均能量图上调整 Alice 的波束方向。障碍物会完全遮断其后的视距传播；启用墙面后，墙与障碍物遵循同一种有损镜面反射规律，合计最多发生三次反射。比较 Bob 与 Eve 的可达速率，并最大化瞬时保密速率。',
        },
        tags: {
          en: ['Instantaneous secrecy rate', 'Energy map', 'Three-bounce reflections'],
          zh: ['瞬时保密速率', '能量覆盖图', '三次反射'],
        },
      },
      {
        id: 'hopper',
    ...
    localized: {
      en: {
        news: {
          ...
          filtersLabel: 'Filter research updates',
          moduleLabel: 'Module',
          ...
          resultsLabel: 'Updates shown',
          resultSingular: 'update',
          resultPlural: 'updates',
          noResultsTitle: 'No updates match all three filters.',
          noResultsBody: 'Reset one or more selections to widen the view.',
          readAction: 'Read update',
          publishedLabel: 'Published',
          coverageLabel: 'Coverage',
          authorsLabel: 'Authors covered',
          moreAuthors: 'and {count} more',
          keywordsLabel: 'Topics',
          backAction: 'Back to Research News',
          archivedLabel: 'Archived update',
          modules: {
            fields: 'Related fields',
            advisors: "Advisors' work",
            interests: 'Research interests',
          },
          keywordGroups: {
            core: 'Core fields',
            active: 'Active research themes',
            watch: 'Watch topics',
            other: 'Other topics',
          },
          keywords: {
            'wireless-communications': 'Wireless communications',
            'physical-layer-security': 'Physical-layer security',
            'convex-optimization': 'Convex optimization',
            'secure-6g': 'Secure 6G',
            'zero-energy-wireless': 'Zero-energy wireless',
            'battery-free-iot': 'Battery-free IoT',
            'ambient-backscatter': 'Ambient backscatter',
            'wireless-power-transfer': 'Wireless power transfer',
            'anti-jamming': 'Anti-jamming',
            'adversarial-wireless-learning': 'Adversarial wireless learning',
            'resilient-wireless': 'Resilient wireless',
            'learning-enabled-wireless': 'Learning-enabled wireless',
            'reinforcement-learning': 'Reinforcement learning',
            'resource-allocation': 'Resource allocation',
            'wireless-resource-allocation': 'Wireless resource allocation',
            'online-optimization': 'Online optimization',
            'energy-constrained-wireless': 'Energy-constrained wireless systems',
            'energy-constrained-iot': 'Energy-constrained IoT',
            'wireless-powered-edge': 'Wireless-powered edge computing',
            ...
            'pinching-antennas': 'Pinching antennas',
            'movable-antennas': 'Movable antennas',
            ris: 'Reconfigurable intelligent surfaces',
            noma: 'Non-orthogonal multiple access',
            isac: 'Integrated sensing and communications',
            'ai-native-wireless': 'AI-native wireless',
            'generative-wireless-receivers': 'Generative wireless receivers',
            'distributed-and-gpu-systems': 'Distributed and GPU systems',
            'edge-and-fog-computing': 'Edge and fog computing',
            'edge-and-fog-systems': 'Edge and fog systems',
          },
        },
        publications: {
      ...
      zh: {
        news: {
          ...
          title: '研究资讯',
          intro:
            '围绕无线通信、物理层安全、强化学习与凸优化，持续整理相关领域、导师成果及关注方向的新进展，并附上可核查的来源。',
          filtersLabel: '筛选研究动态',
          moduleLabel: '模块',
          keywordLabel: '关键词',
          authorLabel: '作者',
          ...
          resultSingular: '条动态',
          resultPlural: '条动态',
          noResultsTitle: '没有同时符合三个条件的动态。',
          noResultsBody: '可重置一项或多项筛选条件以扩大范围。',
          readAction: '阅读动态',
          publishedLabel: '发布日期',
          coverageLabel: '覆盖时间',
          authorsLabel: '本期涉及作者',
          ...
          keywords: {
            ...
            'secure-6g': '安全 6G',
            'zero-energy-wireless': '零能耗无线通信',
            'battery-free-iot': '无电池物联网',
            'ambient-backscatter': '环境反向散射',
            'wireless-power-transfer': '无线能量传输',
            'anti-jamming': '抗干扰',
            'adversarial-wireless-learning': '对抗式无线学习',
            'resilient-wireless': '韧性无线通信',
            'learning-enabled-wireless': '学习驱动无线通信',
            'reinforcement-learning': '强化学习',
            'resource-allocation': '资源分配',
            'wireless-resource-allocation': '无线资源分配',
            'online-optimization': '在线优化',
            'energy-constrained-wireless': '能量受限无线系统',
            'energy-constrained-iot': '能量受限物联网',
            'wireless-powered-edge': '无线供能边缘计算',
            'wireless-optimization': '无线优化',
            'semantic-communications': '语义通信',
            'non-terrestrial-networks': '非地面网络',
            'pinching-antennas': '夹持天线',
            'movable-antennas': '可移动天线',
            ris: '可重构智能表面',
            noma: '非正交多址接入',
            isac: '通感一体化',
            'ai-native-wireless': 'AI 原生无线通信',
            'generative-wireless-receivers': '生成式无线接收机',
            'distributed-and-gpu-systems': '分布式与 GPU 系统',
            'edge-and-fog-computing': '边缘与雾计算',
            'edge-and-fog-systems': '边缘与雾计算系统',
          },
        },
        publications: {
